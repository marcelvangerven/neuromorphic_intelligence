...
notebooks/noise_based_learning_sdi.ipynb replicates learning experiments
notebooks/differential_genetic_programming.ipynb replicates genetic programming experiments

To install this codebase, run the install.sh script (requires uv to be installed: https://docs.astral.sh/uv/getting-started/installation/).

(c) Marcel van Gerven, 2025